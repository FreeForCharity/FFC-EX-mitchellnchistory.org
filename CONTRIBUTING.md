...
- **Production Site:** [https://mitchellnchistory.org](https://mitchellnchistory.org)
...
1. Visit [https://mitchellnchistory.org](https://mitchellnchistory.org)
2. Explore thoroughly and take notes
3. [Create your review issue](https://github.com/FreeForCharity/FFC-EX-mitchellnchistory.org/issues/new?assignees=&labels=documentation%2Creview%2Conboarding&template=reviewer-onboarding.md)
...
2. **Clone your fork**:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/FFC-EX-mitchellnchistory.org.git
...
3. **Add upstream remote**:
   ...
   ```bash
   git remote add upstream https://github.com/FreeForCharity/FFC-EX-mitchellnchistory.org.git
   ```
...
- Report bugs and request features through [GitHub Issues](https://github.com/FreeForCharity/FFC-EX-mitchellnchistory.org/issues)
