...
1. **Search Existing Issues**: Check if your issue has already been reported in the [Issues](https://github.com/FreeForCharity/FFC-EX-mitchellnchistory.org/issues) section
2. **Open a New Issue**: If your issue is new, [create an issue](https://github.com/FreeForCharity/FFC-EX-mitchellnchistory.org/issues/new) with detailed information:
